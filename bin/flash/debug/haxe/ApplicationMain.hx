...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "1",
			company: "Dynomike Games",
			file: "WordNinjaChallenge",
			fps: 60,
			name: "Word Ninja Challenge",
			orientation: "",
			packageName: "Word Ninja Challenge",
			version: "1.0.0",
			windows: [
	...
	#if (js && html5)
	@:keep @:expose("WordNinjaChallenge.embed")
